      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
         ...
         <div className="group hover:bg-white/5 p-3 rounded transition-colors border border-transparent hover:border-gray-800">
             <div className="flex justify-between items-baseline mb-2">
                ...
                <span className="text-gray-500 text-xs">NOV 2023 - MAR 2025</span>
             </div>
         ...
         <div className="group hover:bg-white/5 p-3 rounded transition-colors border border-transparent hover:border-gray-800">
             <div className="flex justify-between items-baseline mb-2">
                ...
                <span className="text-gray-500 text-xs">AUG 2025 - OCT 2025</span>
             </div>
         ...
         <div className="group hover:bg-white/5 p-3 rounded transition-colors border border-transparent hover:border-gray-800">
             <div className="flex justify-between items-baseline mb-2">
                ...
                <span className="text-gray-500 text-xs">AUG 2025 - PRESENT</span>
             </div>
         ...
         <div className="group hover:bg-white/5 p-3 rounded transition-colors border border-transparent hover:border-gray-800">
             <div className="flex justify-between items-baseline mb-2">
                ...
                <span className="text-gray-500 text-xs">NOV 2024 - MAR 2025</span>
             </div>
         ...
         <div className="group hover:bg-white/5 p-3 rounded transition-colors border border-transparent hover:border-gray-800">
             <div className="flex justify-between items-baseline mb-2">
                ...
                <span className="text-gray-500 text-xs">DEC 2024 - MAY 2025</span>
             </div>
